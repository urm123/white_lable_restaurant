			...
			<div class="col-md-10" style="/*background-color: #E5E5E5*/">
				<div class="filter-greybox">
					<div class="select-box1">
						<h4><a href="resturant_review.php"> Reviews </a><a href="resturant_review_support.php"> <span class="p1"> Support Tickets </span></a> 
						<select>
							<option>Tiket Status</option>
						</select>
						<select>
                ...
                <div class="modal-content">
                    <div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-12"> <p><span class="ticket-checkbox"><input type="checkbox" name=""></span>Span Ticket Resolved</p></div>
						</div>
