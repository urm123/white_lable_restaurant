    ...
    <div class="row">
        <div class="panel with-nav-tabs panel-default">
            <div class="panel-heading single-project-nav">
                @include('includes.master-admin-page-header',['active'=>'review-page'])
            </div>
                        ...
                        <div class="restaurant-profile-form">
                            <div class="col-md-9 col-xs-12">
                                <form action="{{ url('master-admin/page-settings/store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" value="reviewpage" name="section">
                                    <div id="menu1" class="tab-pane active">
                                        <div class="card">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    @if(count(config('setting_fields.reviewpage', [])) )
                                                        @foreach(config('setting_fields.reviewpage', []) as $section => $fields)
