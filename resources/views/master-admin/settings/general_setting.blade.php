    ...
    <div class="row">
        <div class="panel with-nav-tabs panel-default">
            <div class="panel-heading single-project-nav">
                @include('includes.master-admin-general-setting-header',['active'=>$section])
            </div>
                                ...
                                <form action="{{ url('master-admin/page-settings/store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div id="menu1" class="tab-pane active">
                                        <div class="card">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    @if(count(config('setting_fields.'.$section, [])) )
                                                        @foreach(config('setting_fields.'.$section, []) as $section => $fields)
