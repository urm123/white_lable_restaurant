                                            ...
                                            <div class="discount-promo-form">
                                                <div>
                                                    <div class="row restaurant-wide-row">
                                                        ...
                                                        <div class="col-md-2 col-sm-2 col-xs-2">
                                                            <div class="material-switch pull-right">
                                                                <input id="specific_menu"
                                                                       name="someSwitchOption0015" type="checkbox"
                                                                       v-model="restaurant.menu_discount"/>
                                                                <label for="specific_menu"
                                                                       class="label-success"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 table-responsive promo-tablee">
                                                            <table>
                                                                <tr v-for="(promotion, index) in promotions">
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 col-sm-4">
                                                                                <div class="material-switch pull-right">
                                                                                    <input :id="'promocode_'+index"
                                                                                           name="someSwitchOption0015"
                                                                                           v-model="!promotion.deleted"
                                                                                           type="checkbox"/>
                                                                                    <label :for="'promocode_'+index"
                                                                                           class="label-success"></label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
        ...
        const promotions = new Vue({
            ...
            methods: {
                saveRestaurant: function () {
                    let $this = this;
                    axios.put('{{route('master-admin.restaurant.update',$restaurant)}}', {
                        _token: '{{csrf_token()}}',
                ...
                addPromoCode: function () {
                    ...
                    if (!this.start_date) {
                        this.promocode_validation.start_date.push('Please enter Expiry Date');
                    }
                    if (!this.limit) {
                ...
                saveMaster: function () {
                    let $this = this;
                    axios.post('{{route('master-admin.promotion.store')}}', {
                        _token: '{{csrf_token()}}',
