                                ...
                                <div
                                    ...
                                    <div align="left" class="img-container left fixedwidth"
                                        ...
                                        <![endif]--><img alt="Image" border="0" class="left fixedwidth"
                                                         src="{{asset('img/NamasteIndia-Logo-OneLine.png')}}"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 12px; line-height: 1.2; text-align: right; word-break: break-word; mso-line-height-alt: 14px; margin: 0;">
                        ...
                        <div class="col num12"
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px; font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div
                                        "lucida="" ,="" grande"="" lucida="" ms",="" sans="" sans,="" sans-serif;"=""
                                        style="font-size: 12px; line-height: 1.2; font-family: 'Montserrat', 'Trebuchet
                                        MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;
                                        color: #555555; mso-line-height-alt: 14px;" tahoma,="" trebuchet=""
                                        unicode",="">
                                        <p style="font-size: 14px; line-height: 1.2; font-family: Montserrat,; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
                                            <strong><span style="font-size: 46px;">Hello, <span
                                                        style="color: #DB6D13; font-size: 46px;">{{$reservation->user->first_name}}</span>!</span></strong>
                                        </p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td style="padding-right: 30px; padding-left: 30px; padding-top: 15px; padding-bottom: 5px; font-family: Arial, sans-serif">
                                <![endif]-->
                                <div
                                    ...
                                    <div
                                        ...
                                        <p style="font-size: 12px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 18px; margin: 0;">
                                            <strong><span style="font-size: 20px;">Your booking is received! Your order ID is: {{$reservation->id}}</span></strong>
                                        </p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td style="padding-right: 30px; padding-left: 30px; padding-top: 15px; padding-bottom: 20px; font-family: Arial, sans-serif">
                                <![endif]-->
                ...
                <div class="block-grid"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <td align="center" width="700"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:25px; padding-bottom:60px;">
                        <![endif]-->
                        <div class="col num12"
                             style="min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top; width: 700px;">
                            <div style="width:100% !important;">
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:54pt; width:251.25pt; v-text-anchor:middle;"
                                                                 arcsize="13%" stroke="false" fillcolor="#3D3BEE">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0,0,0,0">
                                                            <center
                                                                style="color:#ffffff; font-family:Arial, sans-serif; font-size:26px">
                                        <![endif]-->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                        ...
                                        <tr style="vertical-align: top;" valign="top">
                                            <td class="divider_inner"
                                                ...
                                                valign="top">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                       class="divider_content" height="70" role="presentation"
                ...
                <div class="block-grid"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                        ...
                        <td align="center" width="700"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:15px; padding-bottom:35px;">
                        <![endif]-->
                        <div class="col num12"
                             style="min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top; width: 700px;">
                            <div style="width:100% !important;">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                <span
                                                    style="color: #000000; font-size: 14px;"><strong>Namaste India</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
