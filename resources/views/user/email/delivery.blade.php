                                    ...
                                    <div
                                        ...
                                        <p style="font-size: 14px; line-height: 1.2; font-family: Montserrat,; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
                                            <strong><span style="font-size: 46px;">Hello, <span
                                                        style="color: #DB6D13; font-size: 46px;">{{$delivery->user->first_name}}</span>!</span></strong>
                                        </p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p style="font-size: 12px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 18px; margin: 0;">
                                            <strong><span style="font-size: 20px;">Your order is received! Your order ID is: {{$delivery->id}}</span></strong>
                                        </p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
